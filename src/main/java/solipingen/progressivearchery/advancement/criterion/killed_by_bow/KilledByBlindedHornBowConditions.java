...
public class KilledByBlindedHornBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByBlindedHornBowConditions(EntityPredicate.Extended player, EntityPredicate.Extended[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByBlindedHornBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByBlindedHornBowConditions(EntityPredicate.Extended.EMPTY, extendeds, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByBlindedHornBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByBlindedHornBowConditions(EntityPredicate.Extended.EMPTY, extendeds, uniqueEntityTypes);
    }
