...
public class QuickChargeRecipe extends SpecialCraftingRecipe {
    ...
    public ItemStack craft(CraftingRecipeInput craftingRecipeInput, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        if (leftStack.isIn(ItemTags.BOW_ENCHANTABLE) || leftStack.isIn(ItemTags.CROSSBOW_ENCHANTABLE)) {
            RegistryEntryLookup<Enchantment> enchantmentLookup = wrapperLookup.getOrThrow(RegistryKeys.ENCHANTMENT);
    ...
    @Override
    public RecipeSerializer<QuickChargeRecipe> getSerializer() {
