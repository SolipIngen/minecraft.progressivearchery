...
public class KilledByHornBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByHornBowConditions(EntityPredicate.Extended player, EntityPredicate.Extended[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByHornBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByHornBowConditions(EntityPredicate.Extended.EMPTY, extendeds, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByHornBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByHornBowConditions(EntityPredicate.Extended.EMPTY, extendeds, uniqueEntityTypes);
    }
