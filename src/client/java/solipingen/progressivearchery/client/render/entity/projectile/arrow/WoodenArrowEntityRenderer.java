...
public class WoodenArrowEntityRenderer extends ProjectileEntityRenderer<WoodenArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/wooden_arrow.png");
