...
public class EMITippingRecipe implements EmiRecipe {
    ...
    public Identifier getId() {
        ...
        return potionOptional.map(potionEntry -> new Identifier(ProgressiveArchery.MOD_ID,
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addTexture(new EmiTexture(new Identifier(ProgressiveArchery.MOD_ID, "textures/emi/gui/emi_tipping.png"), 16, 0, 16, 16), 6, 61);
