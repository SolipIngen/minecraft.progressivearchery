...
public class ModModelPredicateProvider {
    ...
    private static void registerCrossbow(Item crossbow) {
        ...
        ModelPredicateProviderRegistry.register(crossbow, new Identifier("charged"), (stack, world, entity, seed) -> ModCrossbowItem.isCharged(stack) ? 1.0f : 0.0f);
        ModelPredicateProviderRegistry.register(crossbow, new Identifier("firework"), (stack, world, entity, seed) -> ModCrossbowItem.isCharged(stack) && ModCrossbowItem.hasProjectile(stack, Items.FIREWORK_ROCKET) ? 1.0f : 0.0f);
    }

    private static void registerQuiver(Item quiver) {
        ModelPredicateProviderRegistry.register(quiver, new Identifier("filled"), (stack, world, entity, seed) -> QuiverItem.getAmountFilled(stack));
    }
