...
public class FletcherScreenHandler extends ScreenHandler implements ScreenHandlerListener {
    ...
    private void updateResult() {
        if (this.player instanceof ServerPlayerEntity serverPlayerEntity) {
            ...
            ItemStack itemStack = FletcherBlock.getFletchingRecipe(world, this.inputInventory).map((recipeEntry) ->
                    recipeEntry.value().craft(this.inputInventory, world.getRegistryManager())).orElse(ItemStack.EMPTY);
