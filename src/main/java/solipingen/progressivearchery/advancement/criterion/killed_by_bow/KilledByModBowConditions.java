...
public record KilledByModBowConditions(Optional<LootContextPredicate> player, List<LootContextPredicate> victims, NumberRange.IntRange uniqueEntityTypes) implements AbstractCriterion.Conditions {
    ...
    public static final Codec<KilledByModBowConditions> CODEC = RecordCodecBuilder.create((instance) -> 
        instance.group(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(KilledByModBowConditions::player),
            EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.listOf().optionalFieldOf("victims", List.of()).forGetter(KilledByModBowConditions::victims),
            NumberRange.IntRange.CODEC.optionalFieldOf("unique_entity_types", NumberRange.IntRange.ANY).forGetter(KilledByModBowConditions::uniqueEntityTypes))
        .apply(instance, KilledByModBowConditions::new));


    public static AdvancementCriterion<KilledByModBowConditions> create(EntityPredicate.Builder ... victimPredicates) {
        return ModCriteria.KILLED_BY_BOW.create(new KilledByModBowConditions(Optional.empty(),
                EntityPredicate.contextPredicateFromEntityPredicates(victimPredicates), NumberRange.IntRange.ANY));
    }

    public static AdvancementCriterion<KilledByModBowConditions> create(NumberRange.IntRange uniqueEntityTypes) {
        return ModCriteria.KILLED_BY_BOW.create(new KilledByModBowConditions(Optional.empty(), List.of(), uniqueEntityTypes));
    }
