...
public class PassiveBowAttackGoal<T extends PassiveEntity> extends Goal {
    ...
    protected boolean isHoldingBow() {
        return this.actor.isHolding(stack -> stack.getItem() instanceof RangedWeaponItem);
    }
    ...
    public void stop() {
        ...
        this.cooldown = -1;
        if (this.actor instanceof VillagerEntity villager) {
    ...
    public void tick() {
        ...
        if (this.actor.isUsingItem()) {
            ...
            this.actor.setCurrentHand(ProjectileUtil.getHandPossiblyHolding(this.actor, stack.getItem()));
        }
    }
