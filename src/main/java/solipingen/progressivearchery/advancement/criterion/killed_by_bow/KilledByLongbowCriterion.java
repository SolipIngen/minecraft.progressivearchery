...
public class KilledByLongbowCriterion extends AbstractCriterion<KilledByLongbowConditions> {
    ...
    @Override
    public KilledByLongbowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new KilledByLongbowConditions(extended, extendeds, intRange);
    }
