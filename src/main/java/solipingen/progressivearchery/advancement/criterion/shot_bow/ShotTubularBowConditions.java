...
public class ShotTubularBowConditions extends AbstractCriterionConditions {
    ...
    public ShotTubularBowConditions(LootContextPredicate player, ItemPredicate item) {
        super(ID, player);
        this.item = item;
    }

    public static ShotTubularBowConditions create(ItemPredicate itemPredicate) {
        return new ShotTubularBowConditions(LootContextPredicate.EMPTY, itemPredicate);
    }

    public static ShotTubularBowConditions create(ItemConvertible item) {
        return new ShotTubularBowConditions(LootContextPredicate.EMPTY, ItemPredicate.Builder.create().items(item).build());
    }
