...
public class FletchingRecipeCache {
    ...
    public Optional<RecipeEntry<FletchingRecipe>> getRecipe(World world, RecipeInputInventory inputInventory) {
    ...
    private Optional<RecipeEntry<FletchingRecipe>> getAndCacheRecipe(RecipeInputInventory inputInventory, World world) {
        Optional<RecipeEntry<FletchingRecipe>> optional = world.getRecipeManager().getFirstMatch(FletchingRecipe.Type.INSTANCE, inputInventory, world);
