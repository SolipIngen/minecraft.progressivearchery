    ...
    public static void replaceFletcherProfessionToLeveledTrade(Map<VillagerProfession, Int2ObjectMap<Factory[]>> originalTradeOffers) {
        originalTradeOffers.replace(VillagerProfession.FLETCHER, ModVillagerProfessions.copyToFastUtilMap(
            ImmutableMap.of(
                ...
                3, new Factory[]{new BuyForOneEmeraldFactory(ModItems.COPPER_ARROWHEAD, 18, 16, 20), new BuyForOneEmeraldFactory(ModItems.GOLDEN_ARROWHEAD, 12, 16, 20), 
                ...
                4, new Factory[]{new BuyForOneEmeraldFactory(Items.GOAT_HORN, 1, 16, 30), new BuyForOneEmeraldFactory(ModItems.IRON_ARROWHEAD, 18, 16, 30), 
                ...
                5, new Factory[]{new BuyForOneEmeraldFactory(ModItems.DIAMOND_ARROWHEAD, 1, 16, 30), 
