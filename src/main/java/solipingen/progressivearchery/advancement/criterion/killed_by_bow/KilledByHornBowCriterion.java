...
public class KilledByHornBowCriterion extends AbstractCriterion<KilledByHornBowConditions> {
    ...
    @Override
    public KilledByHornBowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new KilledByHornBowConditions(extended, extendeds, intRange);
    }
