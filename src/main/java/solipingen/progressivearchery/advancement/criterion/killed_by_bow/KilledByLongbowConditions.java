...
public class KilledByLongbowConditions extends AbstractCriterionConditions {
    ...
    public KilledByLongbowConditions(EntityPredicate.Extended player, EntityPredicate.Extended[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByLongbowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByLongbowConditions(EntityPredicate.Extended.EMPTY, extendeds, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByLongbowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByLongbowConditions(EntityPredicate.Extended.EMPTY, extendeds, uniqueEntityTypes);
    }
