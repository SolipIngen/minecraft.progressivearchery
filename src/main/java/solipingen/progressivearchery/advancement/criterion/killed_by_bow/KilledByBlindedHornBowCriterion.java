...
public class KilledByBlindedHornBowCriterion extends AbstractCriterion<KilledByBlindedHornBowConditions> {
    ...
    @Override
    public KilledByBlindedHornBowConditions conditionsFromJson(JsonObject jsonObject, LootContextPredicate extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
