...
public class ModItemTags {
    ...
    public static final TagKey<Item> REPAIRS_COPPER_FUSED_BOWS = TagKey.of(RegistryKeys.ITEM, Identifier.of(ProgressiveArchery.MOD_ID, "repairs_copper_fused_bows"));
