...
public class KilledByModBowCriterion extends AbstractCriterion<KilledByModBowConditions> {
    ...
    @Override
    public KilledByModBowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new KilledByModBowConditions(extended, extendeds, intRange);
    }
