...
public class KilledByTubularBowCriterion extends AbstractCriterion<KilledByTubularBowConditions> {
    ...
    @Override
    public KilledByTubularBowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new KilledByTubularBowConditions(extended, extendeds, intRange);
    }
