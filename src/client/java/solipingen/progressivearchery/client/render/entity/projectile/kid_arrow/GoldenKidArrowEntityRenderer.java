...
public class GoldenKidArrowEntityRenderer extends ProjectileEntityRenderer<GoldenKidArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/golden_kid_arrow.png");
    public static final Identifier TIPPED_TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/tipped_kid_arrow.png");
    ...
    @Override
    public void updateRenderState(GoldenKidArrowEntity arrowEntity, ArrowEntityRenderState arrowEntityRenderState, float f) {
