...
public record KilledByBlindedHornBowConditions(Optional<LootContextPredicate> player, List<LootContextPredicate> victims, NumberRange.IntRange uniqueEntityTypes) implements AbstractCriterion.Conditions {
    ...
    public static final Codec<KilledByBlindedHornBowConditions> CODEC = RecordCodecBuilder.create((instance) -> 
        instance.group(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(KilledByBlindedHornBowConditions::player),
            EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.listOf().optionalFieldOf("victims", List.of()).forGetter(KilledByBlindedHornBowConditions::victims),
            NumberRange.IntRange.CODEC.optionalFieldOf("unique_entity_types", NumberRange.IntRange.ANY).forGetter(KilledByBlindedHornBowConditions::uniqueEntityTypes))
        .apply(instance, KilledByBlindedHornBowConditions::new));


    public static AdvancementCriterion<KilledByBlindedHornBowConditions> create(EntityPredicate.Builder ... victimPredicates) {
        return ModCriteria.KILLED_BY_BLINDED_HORN_BOW.create(new KilledByBlindedHornBowConditions(Optional.empty(),
                EntityPredicate.contextPredicateFromEntityPredicates(victimPredicates), NumberRange.IntRange.ANY));
    }

    public static AdvancementCriterion<KilledByBlindedHornBowConditions> create(NumberRange.IntRange uniqueEntityTypes) {
        return ModCriteria.KILLED_BY_BLINDED_HORN_BOW.create(new KilledByBlindedHornBowConditions(Optional.empty(), List.of(), uniqueEntityTypes));
    }
