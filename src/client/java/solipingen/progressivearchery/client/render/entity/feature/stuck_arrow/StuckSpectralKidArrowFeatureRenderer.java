...
public class StuckSpectralKidArrowFeatureRenderer<T extends LivingEntity, M extends PlayerEntityModel<T>> extends StuckObjectsFeatureRenderer<T, M> {
    private final EntityRenderDispatcher dispatcher;


    public StuckSpectralKidArrowFeatureRenderer(EntityRendererFactory.Context context, LivingEntityRenderer<T, M> entityRenderer) {
    ...
    protected int getObjectCount(T entity) {
        return ((LivingEntityInterface)entity).getStuckSpectralKidArrowCount();
    }
    ...
    protected void renderObject(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Entity entity, float directionX, float directionY, float directionZ, float tickDelta) {
        ...
        SpectralKidArrowEntity arrowEntity = new SpectralKidArrowEntity(entity.getWorld(), entity.getX(), entity.getY(), entity.getZ(), ItemStack.EMPTY, null);
