...
public class KilledByTubularBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByTubularBowConditions(LootContextPredicate player, LootContextPredicate[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByTubularBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByTubularBowConditions(LootContextPredicate.EMPTY, lootContextPredicates, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByTubularBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByTubularBowConditions(LootContextPredicate.EMPTY, extendeds, uniqueEntityTypes);
    }
