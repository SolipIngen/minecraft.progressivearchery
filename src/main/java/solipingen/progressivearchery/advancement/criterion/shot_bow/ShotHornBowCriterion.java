...
public class ShotHornBowCriterion extends AbstractCriterion<ShotHornBowConditions> {
    ...
    @Override
    public ShotHornBowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
