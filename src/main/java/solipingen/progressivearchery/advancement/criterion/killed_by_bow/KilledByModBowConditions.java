...
public class KilledByModBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByModBowConditions(LootContextPredicate player, LootContextPredicate[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByModBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByModBowConditions(LootContextPredicate.EMPTY, lootContextPredicates, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByModBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByModBowConditions(LootContextPredicate.EMPTY, extendeds, uniqueEntityTypes);
    }
