...
public class CopperArrowEntityRenderer extends ProjectileEntityRenderer<CopperArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/copper_arrow.png");
