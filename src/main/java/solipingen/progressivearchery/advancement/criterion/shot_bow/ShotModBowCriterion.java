...
public class ShotModBowCriterion extends AbstractCriterion<ShotModBowConditions> {
    ...
    @Override
    public ShotModBowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
