...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<FletchingScreenHandler> FLETCHING_SCREEN_HANDLER = ModScreenHandlers.register(Identifier.of(ProgressiveArchery.MOD_ID, "fletching"), FletchingScreenHandler::new);
    public static final ScreenHandlerType<FletcherScreenHandler> FLETCHER_SCREEN_HANDLER = ModScreenHandlers.register(Identifier.of(ProgressiveArchery.MOD_ID, "fletcher"), FletcherScreenHandler::new);
