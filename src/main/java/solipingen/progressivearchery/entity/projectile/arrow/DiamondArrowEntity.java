...
public class DiamondArrowEntity extends ModArrowEntity {
    ...
    public DiamondArrowEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntityTypes.DIAMOND_ARROW_ENTITY, DAMAGE_AMOUNT, world, x, y, z, stack);
        this.setSound(ModSoundEvents.DIAMOND_ARROW_HIT);
    }

    public DiamondArrowEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntityTypes.DIAMOND_ARROW_ENTITY, DAMAGE_AMOUNT, world, owner, stack);
        this.setSound(ModSoundEvents.DIAMOND_ARROW_HIT);
    }
