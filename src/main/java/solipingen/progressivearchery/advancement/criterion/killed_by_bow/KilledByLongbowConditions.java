...
public record KilledByLongbowConditions(Optional<LootContextPredicate> player, List<LootContextPredicate> victims, NumberRange.IntRange uniqueEntityTypes) implements AbstractCriterion.Conditions {
    ...
    public static final Codec<KilledByLongbowConditions> CODEC = RecordCodecBuilder.create((instance) -> 
        instance.group(Codecs.createStrictOptionalFieldCodec(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC, "player").forGetter(KilledByLongbowConditions::player), 
            Codecs.createStrictOptionalFieldCodec(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.listOf(), "victims", List.of()).forGetter(KilledByLongbowConditions::victims), 
            Codecs.createStrictOptionalFieldCodec(NumberRange.IntRange.CODEC, "unique_entity_types", NumberRange.IntRange.ANY).forGetter(KilledByLongbowConditions::uniqueEntityTypes))
    ...
    public static KilledByLongbowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByLongbowConditions(Optional.empty(), lootContextPredicates, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByLongbowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByLongbowConditions(Optional.empty(), extendeds, uniqueEntityTypes);
    }
