...
public class QuickChargeRecipe extends SpecialCraftingRecipe {
    ...
    @Override
    public ItemStack craft(RecipeInputInventory craftingInventory, RegistryWrapper.WrapperLookup wrapperLookup) {
        ItemStack itemStack = craftingInventory.getStack(1 + craftingInventory.getWidth()).copy();
        ...
        if (quickChargeLevel <= 0 && (horsehairLeftBl ^ horsehairRightBl)) {
            itemStack.addEnchantment(Enchantments.QUICK_CHARGE, quickChargeLevel + 1);
        }
