...
public record KilledByHornBowConditions(Optional<LootContextPredicate> player, List<LootContextPredicate> victims, NumberRange.IntRange uniqueEntityTypes) implements AbstractCriterion.Conditions {
    ...
    public static final Codec<KilledByHornBowConditions> CODEC = RecordCodecBuilder.create((instance) -> 
        instance.group(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(KilledByHornBowConditions::player),
            EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.listOf().optionalFieldOf("victims", List.of()).forGetter(KilledByHornBowConditions::victims),
            NumberRange.IntRange.CODEC.optionalFieldOf( "unique_entity_types", NumberRange.IntRange.ANY).forGetter(KilledByHornBowConditions::uniqueEntityTypes))
        .apply(instance, KilledByHornBowConditions::new));


    public static AdvancementCriterion<KilledByHornBowConditions> create(EntityPredicate.Builder ... victimPredicates) {
        return ModCriteria.KILLED_BY_HORN_BOW.create(new KilledByHornBowConditions(Optional.empty(),
                EntityPredicate.contextPredicateFromEntityPredicates(victimPredicates), NumberRange.IntRange.ANY));
    }

    public static AdvancementCriterion<KilledByHornBowConditions> create(NumberRange.IntRange uniqueEntityTypes) {
        return ModCriteria.KILLED_BY_HORN_BOW.create(new KilledByHornBowConditions(Optional.empty(), List.of(), uniqueEntityTypes));
    }
