...
public class KilledByBlindedHornBowCriterion extends AbstractCriterion<KilledByBlindedHornBowConditions> {
    public static final Identifier ID = Identifier.of(ProgressiveArchery.MOD_ID, "killed_by_blinded_horn_bow");


    @Override
    public Codec<KilledByBlindedHornBowConditions> getConditionsCodec() {
        return KilledByBlindedHornBowConditions.CODEC;
    }
