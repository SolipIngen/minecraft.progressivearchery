...
public class FletchedArrowCriterion extends AbstractCriterion<FletchedArrowConditions> {
    ...
    @Override
    public FletchedArrowConditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        Item item = null;
        ...
        return new FletchedArrowConditions(extended, item);
    }
