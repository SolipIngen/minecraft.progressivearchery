...
public class KilledByModBowCriterion extends AbstractCriterion<KilledByModBowConditions> {
    static final Identifier ID = new Identifier(ProgressiveArchery.MOD_ID, "killed_by_bow");
    ...
    @Override
    public KilledByModBowConditions conditionsFromJson(JsonObject jsonObject, LootContextPredicate extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
