...
public class BowFusionTemplateItem extends SmithingTemplateItem {
    ...
    private static final Text BOW_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", Identifier.of(ProgressiveArchery.MOD_ID, "bow_fusion"))).formatted(TITLE_FORMATTING);
