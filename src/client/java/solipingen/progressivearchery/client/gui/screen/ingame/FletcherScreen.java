...
public class FletcherScreen extends HandledScreen<FletcherScreenHandler> {
    public static final Identifier TEXTURE = new Identifier(ProgressiveArchery.MOD_ID,"textures/gui/container/fletcher_gui.png");
    ...
    private void drawArrowTexture(DrawContext context) {
        ...
        if (this.handler.isTriggered()) {
            ...
            context.drawTexture(TEXTURE, (this.width - this.backgroundWidth) / 2 + 18, (this.height - this.backgroundHeight) / 2 + 8, 177, 0, 66, 11);
        }
        else {
