...
public class ShotModBowConditions extends AbstractCriterionConditions {
    ...
    public ShotModBowConditions(EntityPredicate.Extended player, ItemPredicate item) {
        super(ID, player);
        this.item = item;
    }

    public static ShotModBowConditions create(ItemPredicate itemPredicate) {
        return new ShotModBowConditions(EntityPredicate.Extended.EMPTY, itemPredicate);
    }

    public static ShotModBowConditions create(ItemConvertible item) {
        return new ShotModBowConditions(EntityPredicate.Extended.EMPTY, ItemPredicate.Builder.create().items(item).build());
    }
