...
public class DiamondKidArrowEntityRenderer extends ProjectileEntityRenderer<DiamondKidArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/diamond_kid_arrow.png");
