...
public class KilledByHornBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByHornBowConditions(LootContextPredicate player, LootContextPredicate[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByHornBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByHornBowConditions(LootContextPredicate.EMPTY, lootContextPredicates, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByHornBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByHornBowConditions(LootContextPredicate.EMPTY, extendeds, uniqueEntityTypes);
    }
