...
public class GoldenKidArrowEntity extends KidArrowEntity {
    ...
    public GoldenKidArrowEntity(World world, double x, double y, double z) {
        super(ModEntityTypes.GOLDEN_KID_ARROW_ENTITY, DAMAGE_AMOUNT, world, x, y, z);
        this.setSound(ModSoundEvents.COPPER_GOLDEN_ARROW_HIT);
    }

    public GoldenKidArrowEntity(World world, LivingEntity owner) {
        super(ModEntityTypes.GOLDEN_KID_ARROW_ENTITY, DAMAGE_AMOUNT, world, owner);
        this.setSound(ModSoundEvents.COPPER_GOLDEN_ARROW_HIT);
    }
