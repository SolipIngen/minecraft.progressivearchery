...
public class KilledByBlindedHornBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByBlindedHornBowConditions(LootContextPredicate player, LootContextPredicate[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByBlindedHornBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByBlindedHornBowConditions(LootContextPredicate.EMPTY, lootContextPredicates, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByBlindedHornBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByBlindedHornBowConditions(LootContextPredicate.EMPTY, extendeds, uniqueEntityTypes);
    }
