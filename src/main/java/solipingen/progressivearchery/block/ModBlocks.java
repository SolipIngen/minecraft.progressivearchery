...
public class ModBlocks {
    ...
    public static final Block POTION_CAULDRON = ModBlocks.registerBlock("potion_cauldron", 
        new PotionCauldronBlock(Biome.Precipitation.NONE, PotionCauldronBlock.POTION_CAULDRON_BEHAVIOR, FabricBlockSettings.copy(Blocks.CAULDRON).luminance(PotionCauldronBlock.LEVEL_TO_LUMINANCE)), false);
