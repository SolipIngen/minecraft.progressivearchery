...
public class DiamondArrowEntityRenderer extends ProjectileEntityRenderer<DiamondArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/diamond_arrow.png");
