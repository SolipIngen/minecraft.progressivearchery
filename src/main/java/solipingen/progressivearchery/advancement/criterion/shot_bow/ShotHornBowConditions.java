...
public class ShotHornBowConditions extends AbstractCriterionConditions {
    ...
    public ShotHornBowConditions(EntityPredicate.Extended player, ItemPredicate item) {
        super(ID, player);
        this.item = item;
    }

    public static ShotHornBowConditions create(ItemPredicate itemPredicate) {
        return new ShotHornBowConditions(EntityPredicate.Extended.EMPTY, itemPredicate);
    }

    public static ShotHornBowConditions create(ItemConvertible item) {
        return new ShotHornBowConditions(EntityPredicate.Extended.EMPTY, ItemPredicate.Builder.create().items(item).build());
    }
