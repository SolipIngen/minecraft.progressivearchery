...
public class StuckCopperKidArrowFeatureRenderer<T extends LivingEntity, M extends PlayerEntityModel<T>> extends StuckObjectsFeatureRenderer<T, M> {
    private final EntityRenderDispatcher dispatcher;


    public StuckCopperKidArrowFeatureRenderer(EntityRendererFactory.Context context, LivingEntityRenderer<T, M> entityRenderer) {
    ...
    protected int getObjectCount(T entity) {
        return ((LivingEntityInterface)entity).getStuckCopperKidArrowCount();
    }
    ...
    protected void renderObject(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Entity entity, float directionX, float directionY, float directionZ, float tickDelta) {
        ...
        CopperKidArrowEntity arrowEntity = new CopperKidArrowEntity(entity.getWorld(), entity.getX(), entity.getY(), entity.getZ(), ItemStack.EMPTY, null);
