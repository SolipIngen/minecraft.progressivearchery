...
public class ModCrossbowItem extends RangedWeaponItem {
    ...
    protected int getWeaponStackDamage(ItemStack projectile) {
        ...
        boolean bl2 = bl && this.material.getMiningLevel() < MiningLevels.IRON;
        boolean bl3 = bl && this.material.getMiningLevel() < MiningLevels.DIAMOND;
    ...
    protected ProjectileEntity createArrowEntity(World world, LivingEntity shooter, ItemStack weaponStack, ItemStack projectileStack, boolean critical) {
        ...
        if (projectileStack.isOf(Items.FIREWORK_ROCKET)) {
            ...
            ((FireworkRocketEntityInterface)projectileEntity).setPower(EnchantmentHelper.getLevel(Enchantments.POWER, weaponStack));
            ((FireworkRocketEntityInterface)projectileEntity).setPunch(EnchantmentHelper.getLevel(Enchantments.PUNCH, weaponStack));
            ((FireworkRocketEntityInterface)projectileEntity).setFlame(EnchantmentHelper.getLevel(Enchantments.FLAME, weaponStack) > 0);
        }
        else {
