...
public class VillagerTrackTargetGoal extends TrackTargetGoal {
    ...
    public boolean canStart() {
        ...
        List<VillagerEntity> list = this.villager.getWorld().getTargets(VillagerEntity.class, this.targetPredicate, this.villager, box);
        List<PlayerEntity> list2 = this.villager.getWorld().getPlayers(this.targetPredicate, this.villager, box);
