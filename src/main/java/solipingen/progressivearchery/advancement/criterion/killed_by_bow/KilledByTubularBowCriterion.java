...
public class KilledByTubularBowCriterion extends AbstractCriterion<KilledByTubularBowConditions> {
    static final Identifier ID = new Identifier(ProgressiveArchery.MOD_ID, "killed_by_tubular_bow");
    ...
    @Override
    public KilledByTubularBowConditions conditionsFromJson(JsonObject jsonObject, LootContextPredicate extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
