...
public abstract class HeldItemRendererMixin {
    ...
    @ModifyVariable(method = "getHandRenderType", at = @At("STORE"), index = 3)
    ...
    @ModifyVariable(method = "getHandRenderType", at = @At("STORE"), index = 4)
    ...
    @ModifyArg(method = "renderFirstPersonItem", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/render/item/HeldItemRenderer;applyEquipOffset(Lnet/minecraft/client/util/math/MatrixStack;Lnet/minecraft/util/Arm;F)V"), index = 1, 
        slice = @Slice(from = @At(value = "INVOKE", target = "Lnet/minecraft/item/CrossbowItem;isCharged(Lnet/minecraft/item/ItemStack;)Z"), to = @At(value = "INVOKE", target = "Lnet/minecraft/item/CrossbowItem;getPullTime(Lnet/minecraft/item/ItemStack;Lnet/minecraft/entity/LivingEntity;)I")))
