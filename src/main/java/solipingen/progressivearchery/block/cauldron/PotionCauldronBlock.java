...
public class PotionCauldronBlock extends AbstractCauldronBlock {
    public static final MapCodec<PotionCauldronBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> 
        instance.group(((MapCodec<Biome.Precipitation>)Biome.Precipitation.CODEC.fieldOf("precipitation")).forGetter(block -> block.precipitation), 
            ((MapCodec<CauldronBehavior.CauldronBehaviorMap>)CauldronBehavior.CODEC.fieldOf("interactions")).forGetter(block -> block.behaviorMap), PotionCauldronBlock.createSettingsCodec())
