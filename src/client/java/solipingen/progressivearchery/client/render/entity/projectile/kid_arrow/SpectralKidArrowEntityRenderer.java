...
public class SpectralKidArrowEntityRenderer extends ProjectileEntityRenderer<SpectralKidArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/entity/projectiles/spectral_kid_arrow.png");
