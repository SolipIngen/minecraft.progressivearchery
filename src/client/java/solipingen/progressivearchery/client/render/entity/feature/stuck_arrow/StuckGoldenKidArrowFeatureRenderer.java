...
public class StuckGoldenKidArrowFeatureRenderer<T extends LivingEntity, M extends PlayerEntityModel<T>> extends StuckObjectsFeatureRenderer<T, M> {
    private final EntityRenderDispatcher dispatcher;


    public StuckGoldenKidArrowFeatureRenderer(EntityRendererFactory.Context context, LivingEntityRenderer<T, M> entityRenderer) {
    ...
    protected int getObjectCount(T entity) {
        return ((LivingEntityInterface)entity).getStuckGoldenKidArrowCount();
    }
    ...
    protected void renderObject(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Entity entity, float directionX, float directionY, float directionZ, float tickDelta) {
        ...
        GoldenKidArrowEntity arrowEntity = new GoldenKidArrowEntity(entity.getWorld(), entity.getX(), entity.getY(), entity.getZ(), ItemStack.EMPTY, null);
