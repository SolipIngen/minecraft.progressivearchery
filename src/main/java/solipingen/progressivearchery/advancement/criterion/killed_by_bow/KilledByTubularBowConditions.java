...
public class KilledByTubularBowConditions extends AbstractCriterionConditions {
    ...
    public KilledByTubularBowConditions(EntityPredicate.Extended player, EntityPredicate.Extended[] victims, NumberRange.IntRange uniqueEntityTypes) {
        super(ID, player);
    ...
    public static KilledByTubularBowConditions create(EntityPredicate.Builder ... victimPredicates) {
        ...
        return new KilledByTubularBowConditions(EntityPredicate.Extended.EMPTY, extendeds, NumberRange.IntRange.ANY);
    }
    ...
    public static KilledByTubularBowConditions create(NumberRange.IntRange uniqueEntityTypes) {
        ...
        return new KilledByTubularBowConditions(EntityPredicate.Extended.EMPTY, extendeds, uniqueEntityTypes);
    }
