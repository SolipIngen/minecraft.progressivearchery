...
public class QuiverFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
    private static final Identifier TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/models/quiver.png");
    private static final Identifier FILLED_TEXTURE = Identifier.of(ProgressiveArchery.MOD_ID, "textures/models/quiver_filled.png");
    ...
    public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, T livingEntity, float f, float g, float h, float j, float k, float l) {
        ...
        if (livingEntity.getMainArm() == Arm.LEFT) {
            ...
            this.left_handed_model.render(matrixStack, vertexConsumer, i, OverlayTexture.DEFAULT_UV);
            if (quiverStack.hasGlint()) {
                this.left_handed_model.render(matrixStack, vertexConsumerProvider.getBuffer(RenderLayer.getArmorEntityGlint()), i, OverlayTexture.DEFAULT_UV);
            }
        }
        else {
            ...
            VertexConsumer vertexConsumer = ItemRenderer.getArmorGlintConsumer(vertexConsumerProvider, RenderLayer.getArmorCutoutNoCull(identifier), false);
            this.right_handed_model.render(matrixStack, vertexConsumer, i, OverlayTexture.DEFAULT_UV);
            if (quiverStack.hasGlint()) {
                this.right_handed_model.render(matrixStack, vertexConsumerProvider.getBuffer(RenderLayer.getArmorEntityGlint()), i, OverlayTexture.DEFAULT_UV);
            }
        }
        matrixStack.pop();
    }
